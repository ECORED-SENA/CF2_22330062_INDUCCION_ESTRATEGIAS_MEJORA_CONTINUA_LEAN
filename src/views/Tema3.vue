...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    img(src="@/assets/curso/temas/tema3/img-2.svg").mb-5
    ...
    p.mb-5 En la siguiente figura 5 se presenta los mecanismos que se deben utilizar para conocer todos los aspectos claves en el desarrollo de implementación de procesos de mejora:

    .titulo-sexto.color-acento-botones.mb-5
      h5 Figura 4.
      span Formatos usados en la documentación de <em>Lean Manufacturing</em>

    img(src="@/assets/curso/temas/tema3/img-4.svg" style="max-width: 610px").mx-auto
